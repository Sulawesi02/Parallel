...
int main() {
    ...
    for (int sizes : {500, 1000, 1500, 2000}) {
        ...
        reset(A, sizes);
        start_time = high_resolution_clock::now(); // 开始时间
        sse_dynamic(A, sizes); // 执行sse优化动态线程高斯消去法
        end_time = high_resolution_clock::now();// 结束时间
        duration = duration_cast<milliseconds>(end_time - start_time).count();// 计算时间差
        cout << "Sizes: " << sizes << ", sse优化动态线程耗时: " << duration << " ms" << endl;
        clear(n);

        reset(A, sizes);
        start_time = high_resolution_clock::now(); // 开始时间
        avx_dynamic(A, sizes); // 执行avx优化动态线程高斯消去法
        end_time = high_resolution_clock::now();// 结束时间
        duration = duration_cast<milliseconds>(end_time - start_time).count();// 计算时间差
        cout << "Sizes: " << sizes << ", avx优化动态线程耗时: " << duration << " ms" << endl;
        clear(n);
        //==================================================================
        reset(A, sizes);
        start_time = high_resolution_clock::now(); // 开始时间
        normal_sem_static(A, sizes); // 执行平凡算法静态8线程+信号量同步高斯消去法
        end_time = high_resolution_clock::now();// 结束时间
        duration = duration_cast<milliseconds>(end_time - start_time).count();// 计算时间差
        ...
        reset(A, sizes);
        start_time = high_resolution_clock::now(); // 开始时间
        sse_sem_static(A, sizes); // 执行sse静态8线程+信号量同步高斯消去法
        end_time = high_resolution_clock::now();// 结束时间
        duration = duration_cast<milliseconds>(end_time - start_time).count();// 计算时间差
        cout << "Sizes: " << sizes << ", sse优化静态线程+信号量同步耗时: " << duration << " ms" << endl;
        clear(n);

        reset(A, sizes);
        start_time = high_resolution_clock::now(); // 开始时间
        avx_sem_static(A, sizes); // 执行avx静态8线程+信号量同步高斯消去法
        end_time = high_resolution_clock::now();// 结束时间
        duration = duration_cast<milliseconds>(end_time - start_time).count();// 计算时间差
        cout << "Sizes: " << sizes << ", avx优化静态线程+信号量同步耗时: " << duration << " ms" << endl;
        clear(n);
        //==================================================================
        reset(A, sizes);
        start_time = high_resolution_clock::now(); // 开始时间
        normal_sem_tri_static(A, sizes); // 执行平凡算法静态8线程+信号量同步+三重循环全部纳入线程函数高斯消去法
        end_time = high_resolution_clock::now();// 结束时间
        duration = duration_cast<milliseconds>(end_time - start_time).count();// 计算时间差
        ...
        reset(A, sizes);
        start_time = high_resolution_clock::now(); // 开始时间
        sse_sem_tri_static(A, sizes); // 执行sse静态8线程+信号量+三重循环全部纳入线程函数高斯消去法
        end_time = high_resolution_clock::now();// 结束时间
        duration = duration_cast<milliseconds>(end_time - start_time).count();// 计算时间差
        cout << "Sizes: " << sizes << ", sse优化静态线程+信号量同步+三重循环全部纳入线程函数耗时: " << duration << " ms" << endl;
        clear(n);

        reset(A, sizes);
        start_time = high_resolution_clock::now(); // 开始时间
        avx_sem_tri_static(A, sizes); // 执行avx静态8线程+信号量+三重循环全部纳入线程函数高斯消去法
        end_time = high_resolution_clock::now();// 结束时间
        duration = duration_cast<milliseconds>(end_time - start_time).count();// 计算时间差
        cout << "Sizes: " << sizes << ", avx优化静态线程+信号量同步+三重循环全部纳入线程函数耗时: " << duration << " ms" << endl;
        clear(n);
        //==================================================================
        reset(A, sizes);
        start_time = high_resolution_clock::now(); // 开始时间
        normal_barrier_static(A, sizes); // 执行平凡算法静态8线程+barrier同步高斯消去法
        end_time = high_resolution_clock::now();// 结束时间
        duration = duration_cast<milliseconds>(end_time - start_time).count();// 计算时间差
        ...
        reset(A, sizes);
        start_time = high_resolution_clock::now(); // 开始时间
        sse_barrier_static(A, sizes); // 执行sse静态8线程+barrier同步高斯消去法
        end_time = high_resolution_clock::now();// 结束时间
        duration = duration_cast<milliseconds>(end_time - start_time).count();// 计算时间差
        cout << "Sizes: " << sizes << ", sse优化静态barrier耗时: " << duration << " ms" << endl;
        clear(n);

        reset(A, sizes);
        start_time = high_resolution_clock::now(); // 开始时间
        avx_barrier_static(A, sizes); // 执行avx静态8线程+barrier同步高斯消去法
        end_time = high_resolution_clock::now();// 结束时间
        duration = duration_cast<milliseconds>(end_time - start_time).count();// 计算时间差
        cout << "Sizes: " << sizes << ", avx优化静态barrier耗时: " << duration << " ms" << endl;
        clear(n);
    }
    return 0;
}
